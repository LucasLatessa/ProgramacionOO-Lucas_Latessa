...
public class VentanaPrincipal extends JFrame {
	...
	private JFormattedTextField ingresarDin;
	@SuppressWarnings("removal")
	public VentanaPrincipal(){
		Image imagenGris = null;
		try {
			imagenGris = ImageIO.read(new File("src/Imagenes/Fondo.jpg"));
		...
		lblPlataDispo.setForeground(new Color(255, 255, 255));
		...
		lblPlataDispoCant.setForeground(new Color(255, 255, 255));
		...
		panel = new JPanelConFondo(imagenGris);
		panelApuestasAbajo.add(panel, BorderLayout.CENTER);
		panel.setLayout(new MigLayout("", "[89px,grow]", "[23px][][][][]"));
		
		btnIngresarDin = new JButton("Ingresar dinero");
		btnIngresarDin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ingresarDin.setVisible(true);
				btnCargar.setVisible(true);
				btnIngresarDin.setVisible(false);
			}
		});
		
		btnIngresarDin.setBackground(new Color(128, 255, 128));
		btnIngresarDin.setForeground(new Color(0, 0, 0));
		panel.add(btnIngresarDin, "cell 0 1,alignx center,aligny center");
		
		btnCargar = new JButton("Cargar");
		btnCargar.setForeground(new Color(0, 0, 0));
		btnCargar.setBackground(new Color(128, 255, 128));
		panel.add(btnCargar, "cell 0 3,alignx center,aligny center");
		btnCargar.setVisible(false);
		panelApuestasArriba = new JPanelConFondo(imagenGris);
		panelApuestas.add(panelApuestasArriba, BorderLayout.NORTH);
		
		ingresarDin = new JFormattedTextField(new Integer(0));
		ingresarDin.setColumns(5);
		panel.add(ingresarDin, "cell 0 2,growx");
		ingresarDin.setVisible(false);
		ingresarDin.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		...
		lblPozo.setForeground(new Color(255, 255, 255));
		...
		lblPozoCant.setForeground(new Color(255, 255, 255));
		lblPozoCant.setFont(new Font("Tahoma", Font.PLAIN, 15));
		panelApuestasArriba.add(lblPozoCant);
		
		JPanel panelAbajo_Cantos = new JPanelConFondo(imagenGris);
		panelDer.add(panelAbajo_Cantos);
		panelAbajo_Cantos.setLayout(new GridLayout(0, 1, 0, 0));
		
		btnIniciarJuego = new JButton("Iniciar juego");
		btnIniciarJuego.setBackground(new Color(58, 58, 58));
		btnIniciarJuego.setForeground(new Color(255, 255, 255));
		panelAbajo_Cantos.add(btnIniciarJuego);
		this.btnIniciarJuego.setVisible(false);
		
		btnPedirCarta = new JButton("Pedir carta");
		btnPedirCarta.setBackground(new Color(58, 58, 58));
		btnPedirCarta.setForeground(new Color(255, 255, 255));
		panelAbajo_Cantos.add(btnPedirCarta);
		btnPedirCarta.setVisible(false);
		
		btnPaso = new JButton("Paso");
		btnPaso.setBackground(new Color(58, 58, 58));
		btnPaso.setForeground(new Color(255, 255, 255));
		panelAbajo_Cantos.add(btnPaso);
		btnPaso.setVisible(false);
		
		JPanel panelCentro = new JPanelConFondo(imagenGris);
		contentPane.add(panelCentro, BorderLayout.CENTER);
		panelCentro.setLayout(new GridLayout(0, 2, 0, 0));
		
		JPanel panelCartasTiradasIzq = new JPanelConFondo(imagenGris);
		panelCentro.add(panelCartasTiradasIzq);
		panelCartasTiradasIzq.setLayout(new GridLayout(0, 1, 0, 0));
		
		JPanel panelCartasTiradas = new JPanelConFondo(imagenGris);
		...
		cartasTiradasJ1.setForeground(new Color(255, 255, 255));
		...
		JPanel panelCartaTiradaJ1 = new JPanelConFondo(imagenGris);
		...
		cartaTiradaJ1_1.setForeground(new Color(255, 255, 255));
		...
		cartaTiradaJ1_2.setForeground(new Color(255, 255, 255));
		...
		JPanel panelCartaTiradaJ2 = new JPanelConFondo(imagenGris);
		...
		cartaTiradaJ2_1.setForeground(new Color(255, 255, 255));
		...
		cartaTiradaJ2_2.setForeground(new Color(255, 255, 255));
		...
		JPanel panelCartaTiradaJ3 = new JPanelConFondo(imagenGris);
		...
		cartaTiradaJ3_1.setForeground(new Color(255, 255, 255));
		...
		cartaTiradaJ3_2.setForeground(new Color(255, 255, 255));
		...
		panelCartaTiradaJ4 = new JPanelConFondo(imagenGris);
		...
		cartaTiradaJ4_1.setForeground(new Color(255, 255, 255));
		...
		cartaTiradaJ4_2.setForeground(new Color(255, 255, 255));
		...
		panelCartaTiradaJ5 = new JPanelConFondo(imagenGris);
		...
		cartaTiradaJ5_1.setForeground(new Color(255, 255, 255));
		...
		cartaTiradaJ5_2.setForeground(new Color(255, 255, 255));
		...
		panelCartaIntermedia = new JPanelConFondo(imagenGris);
		panelCentro.add(panelCartaIntermedia);
		panelCartaIntermedia.setLayout(new GridLayout(0, 1, 0, 0));
		
		panelCartasIntermedias = new JPanelConFondo(imagenGris);
		...
		cartasTiradasJ1_1.setForeground(new Color(255, 255, 255));
		...
		panelCartaIntermediaJ1 = new JPanelConFondo(imagenGris);
		...
		cartaIntermediaJ1.setForeground(new Color(255, 255, 255));
		...
		panelCartaIntermediaJ2 = new JPanelConFondo(imagenGris);
		...
		cartaIntermediaJ2.setForeground(new Color(255, 255, 255));
		...
		panelCartaIntermediaJ3 = new JPanelConFondo(imagenGris);
		...
		cartaIntermediaJ3.setForeground(new Color(255, 255, 255));
		...
		panelCartaIntermediaJ4 = new JPanelConFondo(imagenGris);
		...
		cartaIntermediaJ4.setForeground(new Color(255, 255, 255));
		...
		panelCartaIntermediaJ5 = new JPanelConFondo(imagenGris);
		...
		cartaIntermediaJ5.setForeground(new Color(255, 255, 255));
		...
		JPanel panelNorte = new JPanelConFondo(imagenGris);
		...
		lblNotificaciones.setForeground(new Color(255, 255, 255));
		...
		panelJug2 = new JPanelConFondo(imagenGris);
		panelIzq.add(panelJug2);
		panelJug2.setLayout(new GridLayout(0, 1, 0, 0));
		
		jugador2 = new JLabel("");
		jugador2.setForeground(new Color(255, 255, 255));
		...
		panelJug3 = new JPanelConFondo(imagenGris);
		panelIzq.add(panelJug3);
		panelJug3.setLayout(new GridLayout(0, 1, 0, 0));
		
		jugador3 = new JLabel("");
		jugador3.setForeground(new Color(255, 255, 255));
		...
		panelJug4 = new JPanelConFondo(imagenGris);
		panelIzq.add(panelJug4);
		panelJug4.setLayout(new GridLayout(0, 1, 0, 0));
		
		jugador4 = new JLabel("");
		jugador4.setForeground(new Color(255, 255, 255));
		...
		panelJug5 = new JPanelConFondo(imagenGris);
		panelIzq.add(panelJug5);
		panelJug5.setLayout(new GridLayout(0, 1, 0, 0));
		
		jugador5 = new JLabel("");
		jugador5.setForeground(new Color(255, 255, 255));
	...
	public void onClickCargar(ActionListener listener) {
	...
	public int getDinero() {
		return (int) this.ingresarDin.getValue();
	}
